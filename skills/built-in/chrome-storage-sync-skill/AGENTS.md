# chrome-storage-sync-skill

Browser extension storage sync conventions.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify chrome-storage-sync-skill`.
...
Source references:
- developer.chrome.com: https://developer.chrome.com/docs/extensions/reference/api/storage
