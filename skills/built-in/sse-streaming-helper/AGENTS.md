...
Server-sent event streaming conventions for Python services.
...
Use when:
- The PRD explicitly asks for api behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify sse-streaming-helper`.
...
Source references:
- developer.mozilla.org: https://developer.mozilla.org/en-US/docs/Web/API/Server-sent_events
