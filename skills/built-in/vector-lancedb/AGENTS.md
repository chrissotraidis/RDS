...
Embedded vector store for Python AI services.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify vector-lancedb`.
...
Source references:
- lancedb.github.io: https://lancedb.github.io/lancedb/
