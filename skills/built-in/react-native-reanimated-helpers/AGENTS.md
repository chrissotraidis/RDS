...
Reanimated animation helper conventions.
...
Use when:
- The PRD explicitly asks for mobile behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify react-native-reanimated-helpers`.
...
Source references:
- docs.swmansion.com: https://docs.swmansion.com/react-native-reanimated/
