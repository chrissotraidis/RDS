...
Zustand store conventions for interactive scenes.
...
Use when:
- The PRD explicitly asks for state behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify zustand-game-state`.
