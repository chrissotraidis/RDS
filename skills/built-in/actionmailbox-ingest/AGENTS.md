# actionmailbox-ingest

Rails-specific inbound email ingestion capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify actionmailbox-ingest`.
...
Source references:
- guides.rubyonrails.org: https://guides.rubyonrails.org/action_mailbox_basics.html
