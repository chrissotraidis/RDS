...
Adds the runtime error, tracing, and release-observability contract.

Applies to: rails-web, nextjs-fullstack, python-ai-service, astro-thin-web, web-3d, game-engine, game-asset-pipeline, mobile-native, browser-extension
Category: observability
Maturity: operational
RDS readiness: guide materialization + verify hook

Use when:
- The PRD explicitly asks for observability behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify observability-sentry-otel`.
