...
Rails Active Storage file upload capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify storage-active-storage`.
...
Source references:
- guides.rubyonrails.org: https://guides.rubyonrails.org/active_storage_overview.html
