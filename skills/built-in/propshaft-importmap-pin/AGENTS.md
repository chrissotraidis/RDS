# propshaft-importmap-pin

Rails asset pinning conventions for Propshaft/importmap.
...
Use when:
- The PRD explicitly asks for frontend behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify propshaft-importmap-pin`.
...
Source references:
- github.com: https://github.com/rails/propshaft
- github.com: https://github.com/rails/importmap-rails
