...
Solid Queue schema and runtime health checks.
...
Use when:
- The PRD explicitly asks for jobs behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify solid-queue-doctor`.
...
Source references:
- guides.rubyonrails.org: https://guides.rubyonrails.org/active_job_basics.html#solid-queue
