...
Rapier physics setup for interactive 3D scenes.
...
Use when:
- The PRD explicitly asks for physics behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify rapier-physics`.
