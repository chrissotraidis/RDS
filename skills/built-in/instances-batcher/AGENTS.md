...
Instanced rendering performance helper.
...
Use when:
- The PRD explicitly asks for performance behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify instances-batcher`.
...
Source references:
- drei.docs.pmnd.rs: https://drei.docs.pmnd.rs/performances/instances
