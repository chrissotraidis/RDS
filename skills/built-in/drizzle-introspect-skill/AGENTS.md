# drizzle-introspect-skill

Drizzle schema introspection and migration conventions.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify drizzle-introspect-skill`.
...
Source references:
- orm.drizzle.team: https://orm.drizzle.team/docs/kit-overview
