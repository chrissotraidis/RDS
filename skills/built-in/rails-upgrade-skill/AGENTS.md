...
Rails version drift and upgrade guidance.
...
Use when:
- The PRD explicitly asks for maintenance behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify rails-upgrade-skill`.
