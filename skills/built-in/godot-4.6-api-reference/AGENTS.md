# godot-4.6-api-reference

Pinned Godot 4.6 API reference context.
...
Use when:
- The PRD explicitly asks for docs behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify godot-4.6-api-reference`.
