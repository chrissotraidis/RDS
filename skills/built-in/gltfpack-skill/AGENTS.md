...
gltfpack optimization contract for 3D web assets.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify gltfpack-skill`.
...
Source references:
- github.com: https://github.com/zeux/meshoptimizer/tree/master/gltf
