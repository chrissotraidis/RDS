# auth-rails-generator

Adds the Rails-native authentication implementation contract.
...
Use when:
- The PRD explicitly asks for auth behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify auth-rails-generator`.
...
- Rails Authentication Generator: https://guides.rubyonrails.org/security.html
