...
Presence and collaborative state via Liveblocks.

Applies to: nextjs-fullstack, web-3d
Category: realtime
Maturity: stable
RDS readiness: guide materialization + verify hook

Use when:
- The PRD explicitly asks for realtime behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify realtime-liveblocks`.
...
Source references:
- liveblocks.io: https://liveblocks.io/docs
