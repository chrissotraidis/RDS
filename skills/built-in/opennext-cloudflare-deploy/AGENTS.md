...
OpenNext deployment path for Cloudflare.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify opennext-cloudflare-deploy`.
...
Source references:
- opennext.js.org: https://opennext.js.org/cloudflare
