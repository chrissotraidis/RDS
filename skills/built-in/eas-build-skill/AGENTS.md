...
Expo Application Services build profile and artifact handoff.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify eas-build-skill`.
...
Source references:
- docs.expo.dev: https://docs.expo.dev/build/introduction/
