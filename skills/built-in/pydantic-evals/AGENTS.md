...
Pydantic AI eval fixture and scoring conventions.
...
Use when:
- The PRD explicitly asks for testing behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify pydantic-evals`.
...
Source references:
- ai.pydantic.dev: https://ai.pydantic.dev/evals/
