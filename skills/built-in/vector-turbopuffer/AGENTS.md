...
Managed vector search alternative.

Applies to: nextjs-fullstack, python-ai-service
Category: vector-db
Maturity: beta
RDS readiness: guide materialization + verify hook

Use when:
- The PRD explicitly asks for vector db behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify vector-turbopuffer`.
...
Source references:
- turbopuffer.com: https://turbopuffer.com/docs
