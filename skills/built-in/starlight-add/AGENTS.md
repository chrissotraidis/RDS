...
Astro Starlight docs-site capability.
...
Use when:
- The PRD explicitly asks for content behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify starlight-add`.
