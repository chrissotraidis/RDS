...
Adds the repository-context contract for GitHub-backed brown-field or handoff builds.
...
Use when:
- The PRD explicitly asks for mcp behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify github-mcp`.
