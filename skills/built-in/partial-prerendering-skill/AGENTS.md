# partial-prerendering-skill

Next.js partial prerendering setup metadata.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify partial-prerendering-skill`.
