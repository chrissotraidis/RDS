...
Adds the database inspection and migration safety contract for Postgres-backed builds.

Applies to: rails-web, nextjs-fullstack, python-ai-service, astro-thin-web, mobile-native
Category: database
Maturity: operational
RDS readiness: guide materialization + verify hook

Use when:
- The PRD explicitly asks for database behavior, or the selected stack commonly needs this capability.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify postgres-mcp`.
