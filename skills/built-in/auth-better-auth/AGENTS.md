...
Adds the TypeScript authentication implementation contract for Better Auth.

Applies to: nextjs-fullstack, astro-thin-web, mobile-native, browser-extension
Category: auth
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify auth-better-auth`.
