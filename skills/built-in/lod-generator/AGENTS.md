...
Level-of-detail asset generation contract.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify lod-generator`.
...
Source references:
- github.com: https://github.com/zeux/meshoptimizer
