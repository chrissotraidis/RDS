...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify godot-web-export`.
...
Source references:
- docs.godotengine.org: https://docs.godotengine.org/en/stable/tutorials/export/exporting_for_web.html
