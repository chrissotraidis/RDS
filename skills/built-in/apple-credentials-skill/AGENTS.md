# apple-credentials-skill

Records Apple Developer credential requirements for iOS builds.
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify apple-credentials-skill`.
...
Source references:
- developer.apple.com: https://developer.apple.com/help/account/
