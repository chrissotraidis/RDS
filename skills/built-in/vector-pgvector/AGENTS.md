...
Adds the Postgres vector search and embedding storage contract.

Applies to: rails-web, nextjs-fullstack, python-ai-service
Category: vector-db
...
Verification:
- Run or document the skill verify hook: `bin/rds-skill-verify vector-pgvector`.
